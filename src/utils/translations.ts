...
export const translations = {
  ko: {
    ...
    infoSection: {
      ...
      sources: [
        { name: "대기 잡음", desc: "지구 대기에서 발생하는 전자기적 잡음은 태양 활동, 번개, 인공 위성 신호 등에 의해 발생하며, 이를 고속 샘플링하여 랜덤 시드로 변환합니다." },
        { name: "양자 불확정성", desc: "아원자 입자의 불확정적 거동을 기반으로 생성되며, 양자 얽힘과 측정 불확정성으로부터 진정한 무작위성을 얻습니다." },
        { name: "열 잡음", desc: "전자 기기 내부에서 발생하는 열 역학적 미세 진동을 측정하여 랜덤 시드로 활용합니다." },
        { name: "하드웨어 시계 지터", desc: "CPU 클록의 미세 오차를 추출하여 랜덤 시드로 사용합니다." }
      ]
    },
    footer: {
  ...
  en: {
    ...
    infoSection: {
      ...
      sources: [
        ...
        { name: "Hardware Clock Jitter", desc: "Extracts micro‑errors in CPU processing time (nanoseconds)." }
      ]
    },
    footer: {
      rights: "© 2026 True Random Lotto Generator. All rights reserved.",
